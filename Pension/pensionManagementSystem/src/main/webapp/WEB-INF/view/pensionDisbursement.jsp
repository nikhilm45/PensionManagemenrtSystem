...
<body    
	style="background-image: url(https://peoplefactor.co.za/wp-content/uploads/2020/04/pension-fund-banner.jpg); background-size: auto; background-repeat: no-repeat; background-position: inherit;">
	<header>
