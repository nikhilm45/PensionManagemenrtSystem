...
<body
	style="background-image: url(https://cdn.pixabay.com/photo/2019/10/19/16/30/poverty-4561704_1280.jpg); background-size:100%;background-repeat: no-repeat; background-position: inherit;">
	<header>
